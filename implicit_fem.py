...
def substep(x, b, v, r0, p0, mul_ans, f):
    global _printed_ast
...
def run_aot_implicit(m, x, b, r0, p0, v, mul_ans, f):
    # m.add_field('f', f)
...
if __name__ == '__main__':
    ...
    if args.aot:
        run_aot(x, b, r0, p0, v, mul_ans, f)
    else:
        run_sim(x, b, r0, p0, v, mul_ans, f)
